...
#         self.new_user.save()
#         self.new_profile = Profile(user = self.new_user, bio = 'Hi, I am new')
...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        self.new_user = User(first_name = 'James', last_name = 'Bond', username = 'jamie', email = 'jamesbond@gmail.com')
        self.new_user.save()
        # self.user = get_user_model().objects.create_user(username='testuser', email='testemail@example.com',password='secret')
        self.new_profile = Profile(user = self.new_user, bio = 'Hi, I am new', profile_photo = 'save.jpg', created = '11/11/2019', updated = '12/11/2019')
        self.new_profile.save()
        self.new_image = Image(image_name = 'Test Image', image_caption = 'This is a random test Post', date_published = '11/11/2019')
        self.new_image.save()
        self.new_image.posted_by = self.new_profile.pk
        self.new_image.save()
        self.new_comment = Comment(post = self.new_image, posted_by = self.new_profile, body = 'Good')
...
#         self.new_user = User(first_name = 'James', last_name = 'Bond', username = 'jamie', email = 'jamesbond@gmail.com')
#         self.new_profile = Profile(user = self.new_user, bio = 'Hi, I am new')
#         self.new_image = Image(image_name = 'Test Image', image_caption = 'This is a random test Post', date_published = '11/11/2019', posted_by = self.new_profile)
#         self.new_comment = Comment(post = self.new_image, posted_by = self.new_profile, body = 'Good')
